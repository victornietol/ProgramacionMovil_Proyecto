                                        ...
                                        builder: (_) => Dialog(
                                          ...
                                          child: InteractiveViewer(
                                            child: Image.asset( // imagen que se abre en pabtalla completa
                                              "assets/finales/imagenes/Final Verdadero.png",
                                              fit: BoxFit.contain,
                                            ),
                                          ),
                                        )
                                  ...
                                  onTap: () {
                                    showDialog(
                                        ...
                                        builder: (_) => Dialog(
                                          ...
                                          child: InteractiveViewer(
                                            child: Image.asset( // imagen que se abre en pabtalla completa
                                              "assets/finales/imagenes/Final Golden.png",
                                              fit: BoxFit.contain,
                                            ),
                                          ),
                                        )
                                  ...
                                  onTap: () {
                                    showDialog(
                                        ...
                                        builder: (_) => Dialog(
                                          ...
                                          child: InteractiveViewer(
                                            child: Image.asset( // imagen que se abre en pabtalla completa
                                              "assets/finales/imagenes/Final Malo.png",
                                              fit: BoxFit.contain,
                                            ),
                                          ),
                                        )
                                  ...
                                  onTap: () {
                                    showDialog(
                                        ...
                                        builder: (_) => Dialog(
                                          ...
                                          child: InteractiveViewer(
                                            child: Image.asset( // imagen que se abre en pabtalla completa
                                              "assets/finales/imagenes/Final Complice.png",
                                              fit: BoxFit.contain,
                                            ),
                                          ),
                                        )
                                  ...
                                  onTap: () {
                                    showDialog(
                                        ...
                                        builder: (_) => Dialog(
                                          ...
                                          child: InteractiveViewer(
                                            child: Image.asset( // imagen que se abre en pabtalla completa
                                              "assets/finales/imagenes/Final Normal.png",
                                              fit: BoxFit.contain,
                                            ),
                                          ),
                                        )
                                  ...
                                  onTap: () {
                                    showDialog(
                                        ...
                                        builder: (_) => Dialog(
                                          ...
                                          child: InteractiveViewer(
                                            child: Image.asset( // imagen que se abre en pabtalla completa
                                              "assets/finales/imagenes/extra 1.png",
                                              fit: BoxFit.contain,
                                            ),
                                          ),
                                        )
                                  ...
                                  onTap: () {
                                    showDialog(
                                        ...
                                        builder: (_) => Dialog(
                                          ...
                                          child: InteractiveViewer(
                                            child: Image.asset( // imagen que se abre en pabtalla completa
                                              "assets/finales/imagenes/extra 2.png",
                                              fit: BoxFit.contain,
                                            ),
                                          ),
                                        )
